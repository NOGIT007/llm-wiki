...
Anthropic is an AI safety company and the creator of [[Claude]]. Founded with a focus on building reliable and interpretable AI systems, Anthropic develops the models behind [[Claude Desktop]] and [[Claude Code]].

## Role in the Corpus

Anthropic appears in three distinct capacities across sources:
...
- [[Claude]] -- The core AI assistant model
- [[Claude Desktop]] -- GUI application for Claude
